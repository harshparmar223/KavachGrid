/*
 * ============================================================
 *  KAVACHGRID 3.0 — Consumer Node Firmware (House 2)
 *  Board: ESP-12E / NodeMCU (ESP8266) or ESP32
 *  Sensors:
...
// ---- HOUSE 2 IDENTITY ----
const char* DEVICE_ID     = "CONSUMER-H2";
const char* MQTT_TOPIC    = "kavachgrid/meter/CONSUMER-H2";
const char* ALERT_TOPIC   = "kavachgrid/alerts/CONSUMER-H2";
// =======================================================
