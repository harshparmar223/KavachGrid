...
const FoldText = ({
      ...
      return (
        ...
        >
          <span
            ...
            style={{ transformOrigin: hingeConfig.origin, ['--fold-crease' as any]: 0 }}
          >
            {content || '\u00A0'}
          </span>
        </span>
  ...
  const rootStyle: React.CSSProperties & Record<string, string | number> = {
    ['--fold-text-font-size' as string]: typeof fontSize === 'number' ? `${fontSize}px` : fontSize,
    ['--fold-text-font-weight' as string]: fontWeight,
    ['--fold-text-color' as string]: color,
    ...style,
  };
